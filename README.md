...
Messaging for Aicountly — a React single-page app built with Vite and TypeScript,
...
(`https://messaging.gh.aicountly.com/api`) so the token exchange has somewhere to
