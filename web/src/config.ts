...
export const APP_NAME = (import.meta.env.VITE_APP_NAME ?? 'Messaging').trim() || 'Messaging'
 ...
 * with the app on both messaging.aicountly.com and messaging.gh.aicountly.com. That
