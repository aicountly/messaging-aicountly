 ...
 * messaging.aicountly.com and messaging.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'messaging').trim() || 'messaging'
...
/**
 * `messaging.aicountly.com` and `messaging.gh.aicountly.com` both resolve to
 * `messaging`, which is what the portal expects in authentication_jump.
 */
